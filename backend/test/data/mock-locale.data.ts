import { LocaleApiResponse } from '../../src/modules/currency/managers/locale/interfaces/locale.interface';

const mockLocaleApiResponse: LocaleApiResponse = [
  {
    name: {
...
export { mockLocaleApiResponse, diffrentLocaleResponse };
